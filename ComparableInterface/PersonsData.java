...
public class PersonsData extends Person implements Comparable<PersonsData>{
    ...
    @Override
    // Returns the larger age
    public int compareTo(PersonsData o) {
        if(o.age > this.age){
                return 1;
        } else {
            return 0;
    ...
    public static boolean getBooleanResult(int result){
        if (result >= 1){
            return true;
        } else {
            return false;
