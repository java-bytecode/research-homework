package com.cyberxnuke.ComparableInterface;
...
public class DriverCode {
    public static void main(String[] args){
        ...
        // Person4
        PersonsData p2Data = new PersonsData("Alex", 50, "Male", 1020304050L, address3);

        // compareTo
        String result = PersonsData.getBooleanResult(pData.compareTo(p2Data)) ? p2Data.getPersonName() : pData.getPersonName();
        System.out.println("Who is older? " + result + " is older!" + "\n");
